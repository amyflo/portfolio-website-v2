---
title: "SpaceMail"
description: SpaceMail is a Unity-based digital narrative game that explores political rebellion, ethics, and space. 
date: "2022-07-12"
slug: "/spacemail"
...
import { Container, Box, Heading, SimpleGrid, List, ListItem, ListIcon, OrderedList, UnorderedList } from "@chakra-ui/react";
...
<SimpleGrid mb={4} columns={[1,1,2]} gap='4'>
  <Box>
...
<GatsbyImage alt='alt-text-missing' image={getImage(props.localImages[15])} />
