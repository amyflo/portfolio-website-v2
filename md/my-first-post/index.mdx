...
![Solve for an accessibility need, Liv was new to Adobe XD, Design for low-bandwidth areas, We were new to Android design, Brief project timeline: 1 week](./constraints.png "Our design constraints during the competition")
...
![Early low-fidelity wireframes of Stamply](./designthinking.png "Early low-fidelity wireframes of Stamply")
...
![A user flow map of possible app features](./low_fi.png "A user flow map of possible app features")
...
![A user flow map of possible app features](./userflowmap.png "A user flow map of possible app features")
